...
%caculate the prior probability
...
%caculate the gaussian values for each color with class 1-5, multiply all
%of them.

gaussian_values = get_gaussian_value(Features_predicted, training_mean, training_variance, training_prior);
